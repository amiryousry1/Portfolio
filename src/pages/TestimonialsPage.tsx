          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-[#1a1f2e] to-[#151a25] p-8 rounded-3xl shadow-xl border border-[#C1AA7E]/20 hover:border-[#C1AA7E]/40 transition-all h-full flex flex-col">
                  {/* Quote Icon */}
                  <div className="absolute -top-4 -right-4 w-14 h-14 bg-gradient-to-br from-[#C1AA7E] to-[#a89363] rounded-full flex items-center justify-center shadow-lg shadow-[#C1AA7E]/30 group-hover:scale-110 transition-transform">
                  ...
                  <div className="flex gap-1 mb-6 justify-center">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-6 h-6 fill-[#C1AA7E] text-[#C1AA7E]"
                      />
                    ))}
                  </div>
                  ...
                  <div className="flex justify-center mb-6">
                    <div className="w-2 h-2 bg-[#C1AA7E]/50 rounded-full"></div>
                  </div>

                  {/* Author */}
                  <div className="flex flex-col items-center gap-3">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#C1AA7E] to-[#a89363] rounded-full flex items-center justify-center text-[#0f1419] text-lg font-semibold shadow-md shadow-[#C1AA7E]/30">
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-[#C1AA7E]">
                        {testimonial.company}
                      </div>
                    </div>
                  </div>
