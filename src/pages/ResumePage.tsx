          ...
          >
            ...
            <div className="flex flex-wrap gap-6 text-gray-400">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href={profile.phoneLink} target="_blank" rel="noopener noreferrer" className="hover:text-[#CBA135] transition-colors" dir="rtl">
                  {profile.phoneLabel}
                </a>
              </div>
              <div className="flex items-center gap-2">
